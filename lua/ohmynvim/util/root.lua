...
function M.info()
  ...
  lines[#lines + 1] = "```"
  require("ohmynvim.util").info(lines, { title = "OhMyNvim Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    Util.root.info()
  end, { desc = "OhMyNvim roots for the current buffer" })

  vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost" }, {
    group = vim.api.nvim_create_augroup("ohmynvim_root_cache", { clear = true }),
